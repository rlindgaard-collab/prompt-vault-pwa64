    ...
    <header className="h-16 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-3">
        <button onClick={onToggleFav}
          className={"p-2 rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-soft hover:shadow-soft " + (showFav ? "ring-2 ring-amber-400/60 border-amber-500" : "")}
        ...
        <button onClick={onToggleCustom}
          className={"p-2 rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-soft hover:shadow-soft " + (showCustom ? "ring-2 ring-amber-400/60 border-amber-500" : "")}
